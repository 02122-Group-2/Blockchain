...
// 	signedTx1, _ := state.SignTransaction(testWallet1, pswd, state.CreateTransaction("Magn", "Niels", 10))
// 	signedTx2, _ := state.SignTransaction(testWallet2, pswd, state.CreateTransaction("Niels", "Magn", 10))
